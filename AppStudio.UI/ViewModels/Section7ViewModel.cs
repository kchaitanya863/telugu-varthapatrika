...
{
    public class Section7ViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "DataSource7DataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new DataSource7DataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("Section7Detail");
        }
    }
}
