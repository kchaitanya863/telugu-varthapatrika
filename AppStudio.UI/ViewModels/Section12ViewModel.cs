...
{
    public class Section12ViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "DataSource12DataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new DataSource12DataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("Section12Detail");
        }
    }
}
