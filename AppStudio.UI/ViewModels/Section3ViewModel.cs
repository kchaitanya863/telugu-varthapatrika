...
{
    public class Section3ViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "DataSource3DataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new DataSource3DataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("Section3Detail");
        }
    }
}
