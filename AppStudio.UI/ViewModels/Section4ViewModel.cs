...
{
    public class Section4ViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "DataSource4DataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new DataSource4DataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("Section4Detail");
        }
    }
}
